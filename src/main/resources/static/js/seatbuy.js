    ...
    */
    ...
    var updateTotal = function updateTotal() {
        if (shoppingCartTotal !== undefined) {
            shoppingCartTotal.textContent = '总计: {0}{1}'.format(self.getTotal(), self.currency);
        }
    };
    ...
    this.createLegend = function createLegend(containerId) {
        ...
        seatsList.appendChild(createLegendItem('可选', 'available'));
        seatsList.appendChild(createLegendItem('已售', 'unavailable'));
    ...
    var createScTotal = function createScTotal() {
        ...
        shoppingCartTotal = createSmallTitle('总价: {0}{1}'.format(self.getTotal(), self.currency));
